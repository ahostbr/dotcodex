---
name: find-skill-sh
description: "Use when searching the skills.sh ecosystem for technology-specific procedural knowledge or installable skill packages. Triggers on 'find-skill-sh', 'search skills.sh', 'find a skill on skills.sh', or when looking for community-created skills for a specific technology or framework."
