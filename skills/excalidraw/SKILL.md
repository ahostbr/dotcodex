---
name: excalidraw
description: "Use when working with existing .excalidraw or .excalidraw.json files — reading, understanding, modifying, or comparing them. Delegates to subagents to prevent context exhaustion from verbose JSON. Triggers when file paths contain '.excalidraw', 'explain this diagram', 'update the diagram'. NOT for creating new diagrams from scratch."
---
