...
description: "Use when creating new Excalidraw diagrams that need icon library support (AWS, GCP, cloud architecture icons) or raw Excalidraw JSON output with specific element positioning. Triggers on 'create an AWS architecture diagram', 'make a diagram with cloud icons', 'generate Excalidraw with icons'. For simple diagrams without icon libraries, prefer excalidraw-diagrams."
---
