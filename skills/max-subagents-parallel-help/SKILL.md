...
description: "Use when the user needs help or reference for the max-subagents-parallel system — flags, strategies, model tiering, or how to configure parallel agent spawning. Triggers on 'max-subagents-parallel-help', 'how does parallel mode work', 'parallel agent flags', or questions about parallel decomposition configuration."
---
