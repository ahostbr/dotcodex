...
description: "Use when creating new flowcharts, architecture diagrams, mind maps, or system design diagrams programmatically. Primary diagram creation skill — uses Python API (Diagram, Flowchart, ArchitectureDiagram classes). Triggers on 'create a flowchart', 'diagram this architecture', 'make a system diagram', 'visualize this process', 'draw a mind map'."
---
...
import sys
import os
sys.path.insert(0, os.path.expanduser("~/.codex/skills/excalidraw-diagrams/scripts"))
...
cd ~/.codex/skills/excalidraw-diagrams/scripts
npm install
npx playwright install chromium

# Export to PNG
node ~/.codex/skills/excalidraw-diagrams/scripts/export_playwright.js diagram.excalidraw output.png
```
...
subprocess.run([
    "node", os.path.expanduser("~/.codex/skills/excalidraw-diagrams/scripts/export_playwright.js"),
    "/tmp/architecture.excalidraw", "/tmp/architecture.png"
])

# 4. Upload PNG to Drive and share
drive_script = os.path.expanduser("~/.codex/skills/google-docs/scripts/drive_manager.rb")
...
docs_script = os.path.expanduser("~/.codex/skills/google-docs/scripts/docs_manager.rb")
